...
var DEFAULT_BACKGROUND_COLOR = '#1d1d1d';
function DancingLines(props) {
    var _a = props.debug, debug = _a === void 0 ? false : _a, _b = props.friction, friction = _b === void 0 ? 0.5 : _b, _c = props.trails, trails = _c === void 0 ? 20 : _c, _d = props.size, size = _d === void 0 ? 50 : _d, _e = props.dampening, dampening = _e === void 0 ? 0.25 : _e, _f = props.tension, tension = _f === void 0 ? 0.98 : _f, _g = props.backgroundColor, backgroundColor = _g === void 0 ? DEFAULT_BACKGROUND_COLOR : _g;
